...
import { searchCategoryProducts } from "../queries";
import { CategoryProductType } from "../types";
import { cn } from "@/lib/utils";

export function CategoryAddProductSearch({
  children,
  setProduct,
  products,
}: {
  ...
  setProduct: (p: CategoryProductType) => void;
}) {
                ...
                page.products.map((product) => (
                  <div
                    ...
                    className={cn(
                      ...
                      products.includes(product) && "text-muted-foreground",
                    )}
                  >
